...
function generateHex() {
  // Returns random colour generated by chroma
...
function randomColors() {
  ...
  colorDivs.forEach((div, index) => {
    ...
    // adds colour to initial colors array, if locked, keeps that colour in array, if not adds random
    ...
    // Add colour to background and text
    ...
    // Initialise background for input sliders
...
function checkTextContrast(color, text) {
  // sets colour to white or black depending on contrast
